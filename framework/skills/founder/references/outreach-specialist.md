...
```
Read: outreach-specialist/outreach-templates.md
Read: outreach-specialist/sequence-strategy.md
```
...
| File | Purpose |
|------|---------|
| `outreach-specialist/outreach-templates.md` | 8 proven outreach message templates with examples, psychology, and when-to-use logic |
| `outreach-specialist/sequence-strategy.md` | Follow-up sequence structures, timing, platform rules, and proven patterns |
...
### Pre-Execution Check
- [ ] I read `outreach-specialist/outreach-templates.md` before writing messages
- [ ] I read `outreach-specialist/sequence-strategy.md` before writing messages
