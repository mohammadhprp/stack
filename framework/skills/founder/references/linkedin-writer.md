...
```
Read: linkedin-writer/linkedin-formats.md
Read: linkedin-writer/linkedin-posts.md
```
...
| File | Purpose |
|------|---------|
| `linkedin-writer/linkedin-formats.md` | 7 proven LinkedIn post formats with structure templates, psychology, rules, and when-to-use matching logic |
| `linkedin-writer/linkedin-posts.md` | 8+ proven viral LinkedIn posts organized by format — the example and voice library |
...
### Pre-Execution Check
- [ ] I read `linkedin-writer/linkedin-formats.md` before generating posts
- [ ] I read `linkedin-writer/linkedin-posts.md` before generating posts
