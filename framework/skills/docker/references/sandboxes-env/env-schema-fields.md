...
[`sandboxes-kits.md`](../sandboxes-kits.md) for what a kit itself may declare under `args:`.
...
workspace arguments with a `:ro` suffix — see [`sandboxes-lifecycle.md`](../sandboxes-lifecycle.md)
...
Beyond `writableEnvFiles` (covered in the main `../sandboxes-env.md`), `sandboxOptions:`
...
shared skills store mode). See [`sandboxes-lifecycle.md`](../sandboxes-lifecycle.md) for what each
