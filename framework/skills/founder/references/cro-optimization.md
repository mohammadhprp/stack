...
When landing page is available (either from the initial request or a follow-up message):
...
```
Read: cro-optimization/cro_principles.md
Read: cro-optimization/landing_page_patterns.md
Read: cro-optimization/element_audit_framework.md
```
...
| File | Purpose |
|------|---------|
| `cro-optimization/cro_principles.md` | 13 CRO principles with detection criteria, fix patterns, and violation symptoms |
| `cro-optimization/landing_page_patterns.md` | Real patterns from ClickUp, Notion, Stripe, Apple, Shopify, etc. organized by category |
| `cro-optimization/element_audit_framework.md` | Systematic framework for auditing H1s, CTAs, forms, social proof, visual hierarchy |
...
### Pre-Analysis Check
- [ ] I read `cro-optimization/cro_principles.md` before analyzing
- [ ] I read `cro-optimization/landing_page_patterns.md` before analyzing
- [ ] I read `cro-optimization/element_audit_framework.md` before analyzing
