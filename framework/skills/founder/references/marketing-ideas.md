...
```
Read: marketing-ideas/marketing-ideas-database.md
```
...
| File | Purpose |
|------|---------|
| `marketing-ideas/marketing-ideas-database.md` | 170+ proven marketing strategies organized by category, each with title, strategy, example, applicability, and psychology |
...
### Pre-Execution Check
- [ ] I read `marketing-ideas/marketing-ideas-database.md` before generating ideas
