...
When user requirements are available (either from the initial request or a follow-up message):
...
```
Read: lead-magnet-generator/lead-magnet-patterns.md
Read: viral-hook-creator/hook-patterns.md
Read: viral-hook-creator/trigger_words.md
```

**What you will find:**
- **lead-magnet-patterns.md**: Lead magnet post structures, value framing techniques, and CTA patterns
- **hook-patterns.md**: 18 proven viral hook patterns with templates and psychology (from the [`viral-hook-creator`](viral-hook-creator.md) reference)
- **trigger_words.md**: Four categories of viral trigger words (from the [`viral-hook-creator`](viral-hook-creator.md) reference)
...
Using the hook patterns and trigger words from the [`viral-hook-creator`](viral-hook-creator.md) reference (read in Step 1), generate exactly 2 opening hook options:
...
### Opening Hook Rules
- Opening hooks MUST use patterns from the [`viral-hook-creator`](viral-hook-creator.md) hook patterns
...
| File | Purpose |
|------|---------|
| `lead-magnet-generator/lead-magnet-patterns.md` | Value anchors, CTA patterns, post structures, and examples |
| `viral-hook-creator/hook-patterns.md` | 18 proven viral hook patterns for opening lines |
| `viral-hook-creator/trigger_words.md` | Viral trigger words to integrate into hooks |
...
### Pre-Execution Check
- [ ] I read `lead-magnet-generator/lead-magnet-patterns.md` before generating posts
- [ ] I read `viral-hook-creator/hook-patterns.md` before generating hooks
- [ ] I read `viral-hook-creator/trigger_words.md` before generating hooks
