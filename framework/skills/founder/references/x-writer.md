...
```
Read: x-writer/formats.md
Read: x-writer/posts.md
Read: x-writer/voices.md
```
...
| File | Purpose |
|------|---------|
| `x-writer/formats.md` | 8 proven post formats with structure templates, psychology, and rules |
| `x-writer/posts.md` | 51+ proven viral posts organized by format — the example library |
| `x-writer/voices.md` | 7 creator voice profiles (Hormozi, Naval, Gazdecki, Dakota, Machina, Ognjen, Dan Koe) with writing DNA and example posts |
...
### Pre-Execution Check
- [ ] I read `x-writer/formats.md` before generating posts
- [ ] I read `x-writer/posts.md` before generating posts
- [ ] I read `x-writer/voices.md` before generating posts
