...
cp ../assets/sandboxes-kits/spec-sandbox.yaml "$WORK/kit-sandbox-example/spec.yaml"
cp ../assets/sandboxes-kits/spec-mixin.yaml "$WORK/kit-mixin-example/spec.yaml"
```
