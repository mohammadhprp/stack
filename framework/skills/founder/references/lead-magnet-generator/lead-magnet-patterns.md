...
> **Note:** Opening hooks are generated using [`viral-hook-creator`](../viral-hook-creator.md) patterns. This file focuses on value anchors, CTAs, and post structure.
...
1. **Viral hook** — Stops the scroll with curiosity (from the [`viral-hook-creator`](../viral-hook-creator.md) reference)
