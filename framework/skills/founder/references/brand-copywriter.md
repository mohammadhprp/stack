...
```
Read: brand-copywriter/copy_frameworks.md
Read: brand-copywriter/writing_styles.md
```
...
| File | Purpose |
|------|---------|
| `brand-copywriter/copy_frameworks.md` | 14 copywriting frameworks with structures, examples, and selection matrix |
| `brand-copywriter/writing_styles.md` | Voice and tone rules from Ogilvy, Schwartz, Hopkins, Halbert, Sugarman, Caples, Collier. Contains the full Banned Phrases list, AI tell patterns, and what human copy actually sounds like. |
...
### Pre-Execution Check
- [ ] I read `brand-copywriter/copy_frameworks.md` before writing copy
- [ ] I read `brand-copywriter/writing_styles.md` before writing copy
