...
| File | Purpose |
|------|---------|
| `viral-hook-creator/hook-patterns.md` | 18 proven hook patterns with templates, psychology, and Pattern Selection Matrix |
| `viral-hook-creator/trigger_words.md` | Viral trigger word categories (Insider, Helper, Thinker, Amplifiers) |
