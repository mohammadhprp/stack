...
misspelled — check `../references/agent-config/toolsets-and-providers.md`.
...
found. Fail: "No model is currently available" — use [`agent-run.md`](../references/agent-run.md) for
